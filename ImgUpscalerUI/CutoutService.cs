...
public static class CutoutService
{
    ...
    private static float[] UpsampleMask(float[,] mask, int w, int h)
    {
        ...
        using var small = new System.Drawing.Bitmap(mw, mh, System.Drawing.Imaging.PixelFormat.Format32bppArgb);
        var msRect = new System.Drawing.Rectangle(0, 0, mw, mh);
        var msData = small.LockBits(msRect, System.Drawing.Imaging.ImageLockMode.WriteOnly,
            System.Drawing.Imaging.PixelFormat.Format32bppArgb);
        try
        {
            unsafe
